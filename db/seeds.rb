...
review1 = Review.create(
 ...
 review9 = Review.create(
  ...
  post_id: post4.id,
  user_rating: 5,
  comment: "Flying past those windows looks awesome on video. Thanks for posting this spot!",
 )
 ...
 review10 = Review.create(
  ...
  post_id: post4.id,
  user_rating: 4,
  comment: "I got to fly here for a few minutes last week before getting kicked out. Great location with a lot of cool gaps to fly through. ",
 )
 ...
 review11 = Review.create(
  ...
  post_id: post2.id,
  user_rating: 5,
  comment: "Awesome photo! I would love to fly at a location like this but it's a bit far from home haha. One day..",
 )
 ...
 review12 = Review.create(
  ...
  post_id: post2.id,
  user_rating: 4,
  comment: "Looks like a great location. What type of receiver are you using to get the proper range?",
 )
 ...
 review13 = Review.create(
  ...
  post_id: post1.id,
  user_rating: 4,
  comment: "Rally cool park but there was too many people there when I went. I'll let you know how it goes next time!",
 )
 ...
 review14 = Review.create(
  ...
  post_id: post1.id,
  user_rating: 5,
  comment: "I saw someone flying their drone over here a couple of days ago and thought I'd check it out. I flew here on Wednesday and got some really cool footage.",
 )
